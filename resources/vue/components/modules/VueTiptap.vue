<template>
	...
	<VueModal ref="modalUpload" :settings="modalUpload">
		<template #title>{{ modalUpload.values.title }}</template>
		<template #body>
			<VueFile
				...
				@guard="
					({ status, message }) => {
						currentUpload.errors.file.status = status;
						currentUpload.errors.file.message = message;
					}
				"
			>
				<template #label>
				...
				<template #error>
					{{ currentUpload.errors.file.message }}
				</template>
			</VueFile>
		</template>
		<template #footer>
		...
		<div v-if="editor && editable" class="tiptap__buttons">
			<div class="tiptap__buttons-body">
				...
				<div class="tiptap__buttons-item" v-if="options.includes('heading')">
					...
					>
						<svg width="18" height="13" viewBox="0 0 14 10" xmlns="http://www.w3.org/2000/svg">
					...
					>
						<svg width="23" height="15" viewBox="0 0 18 10" xmlns="http://www.w3.org/2000/svg">
							<path
					...
					<div class="tiptap__buttons-item">
						...
						>
							<svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
								<path d="M0 18V16H18V18H0ZM0 14V12H12V14H0ZM0 10V8H18V10H0ZM0 6V4H12V6H0ZM0 2V0H18V2H0Z" />
							</svg>
						</button>
						<button
						...
						>
							<svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
								<path d="M0 18V16H18V18H0ZM4 14V12H14V14H4ZM0 10V8H18V10H0ZM4 6V4H14V6H4ZM0 2V0H18V2H0Z" />
							</svg>
						</button>
						<button
						...
						>
							<svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
								<path d="M0 2V0H18V2H0ZM6 6V4H18V6H6ZM0 10V8H18V10H0ZM6 14V12H18V14H6ZM0 18V16H18V18H0Z" />
							</svg>
						</button>
						<button
						...
						>
							<svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
								<path d="M0 18V16H18V18H0ZM0 14V12H18V14H0ZM0 10V8H18V10H0ZM0 6V4H18V6H0ZM0 2V0H18V2H0Z" />
							</svg>
						</button>
					</div>
				</template>
				...
				<template v-if="options.includes('list')">
					...
					<div class="tiptap__buttons-item">
						...
						>
							<svg width="20" height="14" viewBox="0 0 17 12" xmlns="http://www.w3.org/2000/svg">
								<path
						...
						>
							<svg width="22" height="20" viewBox="0 0 18 20" xmlns="http://www.w3.org/2000/svg">
								<path
...
.tiptap__buttons {
	...
	flex-wrap: wrap;
	gap: var(--tiptap-buttons-gap);

	border-top: var(--tiptap-buttons-border-top);
	border-right: var(--tiptap-buttons-border-right);
	border-left: var(--tiptap-buttons-border-left);
	border-bottom: var(--tiptap-buttons-border-bottom);
	border-style: var(--tiptap-buttons-border-style);
	border-color: var(--tiptap-buttons-border-color);
	border-radius: var(--tiptap-buttons-border-radius);

	padding: var(--tiptap-buttons-padding);
}

.tiptap__buttons-body {
	display: flex;
	flex-wrap: wrap;
	gap: var(--tiptap-buttons-body-gap);
}

.tiptap__buttons-footer {
	display: flex;
	justify-content: space-between;
	gap: var(--tiptap-buttons-footer-gap);
}
...
.tiptap__error {
	...
	user-select: none;
	position: absolute;
	right: var(--tiptap-error-right);
	top: var(--tiptap-error-top);

	border: var(--tiptap-error-border);
	border-radius: var(--tiptap-error-border-radius);
	padding: var(--tiptap-error-padding);

	background-color: var(--tiptap-error-background-color);
	color: var(--tiptap-error-color);

	animation: var(--tiptap-error-animation);
}
</style>
