<template>
	<footer>
		...
		<section class="up">
			...
			<div class="pay">
				<a href="/">
					<img src="../../../../assets/svg/cardiologika/logo-full.svg" width="250" height="150" alt="логотип" />
				</a>
			...
			<div class="more">
				...
				<div class="links">
					<a href="https://ok.ru/group/58676046266377" class="ok" target="_blank">
					...
					<a href="https://vk.com/cardio_tob?from=groups" class="vk" target="_blank">
						<svg viewBox="0 0 317 181" xmlns="http://www.w3.org/2000/svg">
							<path
								fill-rule="evenodd"
								clip-rule="evenodd"
					...
					<a href="https://t.me/cardilogika" class="telegram" target="_blank">
						<svg viewBox="0 0 259 214" xmlns="http://www.w3.org/2000/svg">
							<path
