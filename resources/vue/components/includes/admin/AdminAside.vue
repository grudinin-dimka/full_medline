<template>
	<aside :class="{ active: $store.state.burger.admin.status }">
		<div class="aside-body">
			...
			<div class="item" :class="{ active: links.schedule.status }">
				<a class="item-title" href="#" @click.prevent="insertPage(links.schedule)">
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="26" viewBox="0 0 18 20">
						<path
